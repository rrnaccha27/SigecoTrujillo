...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[up_planilla_contabilidad_planilla_v3]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].up_planilla_contabilidad_planilla_v3
GO


CREATE PROCEDURE [dbo].up_planilla_contabilidad_planilla_v3
(
