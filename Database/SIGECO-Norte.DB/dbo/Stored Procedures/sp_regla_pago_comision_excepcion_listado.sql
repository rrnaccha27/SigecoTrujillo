CREATE PROC dbo.sp_regla_pago_comision_excepcion_listado
(
...
BEGIN
	...
	SELECT 
		r.*, 
		e.nombre nombre_empresa, cg.nombre nombre_canal_grupo, c.nombre nombre_campo_santo, a.nombre nombre_articulo,
		CASE WHEN r.estado_registro = 1 THEN 'Activo' ELSE 'Inactivo' END AS estado_registro_nombre 
	FROM regla_pago_comision_excepcion r
	INNER JOIN articulo a
		ON r.codigo_articulo = a.codigo_articulo
	...
	ORDER BY 
		r.nombre, c.nombre, e.nombre, cg.nombre, a.nombre
END