...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[up_checklist_bono_trimestral_detalle_txt_rrhh]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].up_checklist_bono_trimestral_detalle_txt_rrhh
GO

CREATE PROCEDURE [dbo].up_checklist_bono_trimestral_detalle_txt_rrhh
(
