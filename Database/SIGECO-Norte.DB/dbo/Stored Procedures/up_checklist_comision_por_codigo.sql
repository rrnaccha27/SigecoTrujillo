...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[up_checklist_comision_por_codigo]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].up_checklist_comision_por_codigo
GO

CREATE PROCEDURE dbo.up_checklist_comision_por_codigo
(
