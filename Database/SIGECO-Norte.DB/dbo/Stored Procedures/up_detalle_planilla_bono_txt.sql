...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[up_detalle_planilla_bono_txt]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].up_detalle_planilla_bono_txt
GO

CREATE PROCEDURE [dbo].[up_detalle_planilla_bono_txt]
(
