CREATE PROCEDURE [dbo].up_detalle_planilla_bono_jn_by_id
(
...
BEGIN
	...
	FROM(
		...
		inner join dbo.contrato_planilla_bono cpb on cpb.codigo_planilla = @p_codigo_planilla and case when @v_codigo_tipo_planilla = 1 then cpb.codigo_personal else cpb.codigo_supervisor end = dpb.codigo_personal and cpb.codigo_empresa = dpb.codigo_empresa and cpb.codigo_grupo = dpb.codigo_grupo
