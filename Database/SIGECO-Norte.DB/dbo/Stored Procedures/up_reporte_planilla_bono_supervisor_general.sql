CREATE PROCEDURE [dbo].[up_reporte_planilla_bono_supervisor_general]
(
...
BEGIN
	...
	where dpl.codigo_planilla=@v_codigo_planilla
	...
	from  detalle_planilla_bono dpl 
	where codigo_planilla=@v_codigo_planilla
