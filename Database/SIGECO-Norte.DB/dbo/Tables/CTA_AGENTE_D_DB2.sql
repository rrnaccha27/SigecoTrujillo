CREATE TABLE [dbo].[CTA_AGENTE_D_DB2] (
    ...
    CONSTRAINT [CTA_AGENTE_D_K] PRIMARY KEY NONCLUSTERED ([COD_COMISION] ASC, [N_CUOTA] ASC)
);
GO
CREATE NONCLUSTERED INDEX [_dta_index_cta_agente_d_db2_22_1728061242__K27_K4_K3_K11_K12_13_15]
    ON [dbo].[CTA_AGENTE_D_DB2]([FLAG_SUPERVISOR] ASC, [NUM_CONTRATO] ASC, [COD_EMPRESA_G] ASC, [COD_BIEN] ASC, [COD_CONCEPTO] ASC)
    INCLUDE([IMP_PAGAR], [IGV]);
GO
CREATE NONCLUSTERED INDEX [_dta_index_cta_agente_d_db2_22_846678114__K4_K3_K2_21]
    ON [dbo].[CTA_AGENTE_D_DB2]([NUM_CONTRATO] ASC, [COD_EMPRESA_G] ASC, [N_CUOTA] ASC)
