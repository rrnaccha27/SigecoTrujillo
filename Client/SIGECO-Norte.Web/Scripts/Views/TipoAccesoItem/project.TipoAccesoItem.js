...
(function (app) {
    //===========================================================================================
    var current = app.TipoAccesoItem = {};
    //===========================================================================================

    jQuery.extend(app.TipoAccesoItem,
        {
            ...
            Initialize_DataGrid: function() {
                ...
                $('#DataGrid').datagrid({
                    ...
                    onClickRow: function (index, row) {
                        var rowColumn = row['codigo_tipo_acceso_item'];
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.Msg) {
                            ...
                            Registro =
                            {
                                codigo: data.codigo_tipo_acceso_item,
                                nombre: data.nombre_tipo_acceso_item,
