...
namespace SIGEES.Web.Services
{
    public class TreeNodeService : ITreeNodeService
    {
        ...
        public IResult Update(TreeNode instance, int originalParentID)
        {
            if (instance == null)
            {
                throw new InvalidOperationException("POR FAVOR INTRODUZCA UN NODO");
            ...
            try
            {
                ...
                if (!instance.IsRoot && !instance.ParentID.Equals(originalParentID) && originalParentID != 0)
                {
                    ...
                    //REAJUSTE DEL NODO PRIMARIO ORIGINAL CHILDNODE
                    ...
                    foreach (var item in beforeParentChildren.Where(x => x.Sort > beforeSort))
                    {
                        ...
                        currentNode.Sort -= 1;
                        //System.Diagnostics.Debug.WriteLine("Sort: " + currentNode.Sort);
        ...
        public IResult MoveDirection(int id, Direction direction)
        {
        ...
        /// <returns></returns>
        /// <exception cref="System.NotImplementedException"></exception>
        public TreeNode GetSingle(int id)
        {
