...
{
    public class CaracteristicaLoteService : ICaracteristicaLoteService
    {
        private SIGEESEntities dbContext = new SIGEESEntities();

        private readonly IRepository<caracteristica_lote> _repository;

        public CaracteristicaLoteService()
        {
            this._repository = new DataRepository<caracteristica_lote>(dbContext);
        }

        public IResult Create(caracteristica_lote instance)
        {
            if (instance == null)
            {
            ...
            try
            {
                ...
                result.IdRegistro = instance.codigo_caracteristica_lote.ToString();
                result.Success = true;
            }
            catch (Exception ex)
            {
        ...
        public IResult Update(caracteristica_lote instance)
        {
            if (instance == null)
            {
                throw new InvalidOperationException("REGISTRO NULO");
        ...
        public IResult Delete(caracteristica_lote instance)
        {
            if (null == instance)
            {
        ...
        public caracteristica_lote GetSingle(int id)
        {
            if (this._repository.IsExists(x => x.codigo_caracteristica_lote == id))
            {
                return this._repository.FirstOrDefault(x => x.codigo_caracteristica_lote == id);
            }
            return null;
        }
        ...
        public string GetSingleJSON(int id)
        {
            ...
            var jo = new JObject
            {
                {"codigo_caracteristica_lote", node.codigo_caracteristica_lote.ToString()},
                {"nombre_caracteristica_lote", node.nombre_caracteristica_lote},
        ...
        public IQueryable<caracteristica_lote> GetRegistros(bool isReadAll = false)
        {
        ...
        public string GetAllJson(bool isReadAll = false)
        {
            ...
            if (allNodes.Any())
            {
                foreach (var item in allNodes)
                {
                    ...
                    {
                        {"codigo_caracteristica_lote", item.codigo_caracteristica_lote.ToString()},
                        {"nombre_caracteristica_lote", item.nombre_caracteristica_lote},
        ...
        public string GetComboJson()
        {
            ...
            if (allNodes.Any())
            {
                ...
                {
                    JObject root = new JObject{
                        {"id", item.codigo_caracteristica_lote.ToString()}, 
                        {"text", item.nombre_caracteristica_lote}
                    };
                    jObjects.Add(root);
                }
            }
