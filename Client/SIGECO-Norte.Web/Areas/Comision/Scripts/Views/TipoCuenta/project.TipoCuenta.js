...
(function (app) {
    //===========================================================================================
    var current = app.TipoCuenta = {};
    //===========================================================================================

    jQuery.extend(app.TipoCuenta,
        {
            ...
            Initialize: function (actionUrls) {
                ...
                $('#btnModificar').click(function () {
                    ...
                    if (!Registro.codigo) {
                        ...
                        $('#dlgModificar #simbolo').textbox('setText', Registro.simbolo);
                    }
                });
                ...
                $('#btnVisualizar').click(function () {
                    ...
                    if (!Registro.codigo) {
                        ...
                        $('#dlgVisualizar #simbolo').textbox('setText', Registro.simbolo);
            ...
            Initialize_DataGrid: function() {
                ...
                $('#DataGrid').datagrid({
                    ...
                    columns:
                    [[
                        { field: 'codigo_tipo_cuenta', title: 'Codigo', width: 30, align: 'left' },
                        { field: 'nombre', title: 'Nombre', width: 100, align: 'left' },
                        { field: 'simbolo', title: 'Simbolo', width: 50, align: 'left' }
                    ]],
                    onClickRow: function (index, row) {
                        var rowColumn = row['codigo_tipo_cuenta'];
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.Msg) {
                            ...
                            Registro =
                            {
                                codigo: data.codigo_tipo_cuenta,
                                nombre: data.nombre,
            ...
            Modificar: function () {
                ...
                var simbolo = $.trim($('#dlgModificar #simbolo').textbox('getText'));
                ...
                if (message.length > 0) {
                    ...
                    $.messager.confirm('Confirm', 'Seguro que desea modificar?', function (result) {
                        if (result) {
                            var mapData = { codigo: codigo, nombre: nombre, simbolo: simbolo };
            ...
            Registrar: function () {
                ...
                var simbolo = $.trim($('#dlgRegistrar #simbolo').textbox('getText'));
                ...
                if (message.length > 0) {
                    ...
                    $.messager.confirm('Confirm', 'Seguro que desea registrar?', function (result) {
                        if (result) {
                            var mapData = { nombre: nombre, simbolo: simbolo };
