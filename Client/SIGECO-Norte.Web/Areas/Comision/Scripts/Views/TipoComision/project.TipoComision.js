...
(function (app) {
    //===========================================================================================
    var current = app.TipoComision = {};
    //===========================================================================================

    jQuery.extend(app.TipoComision,
        {
            ...
            Initialize_DataGrid: function() {
                ...
                $('#DataGrid').datagrid({
                    ...
                    columns:
                    [[
                        { field: 'codigo_tipo_comision', title: 'Codigo', width: 30, align: 'left' },
                        { field: 'nombre', title: 'Nombre', width: 100, align: 'left' },
                    ]],
                    onClickRow: function (index, row) {
                        var rowColumn = row['codigo_tipo_comision'];
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.Msg) {
                            ...
                            Registro =
                            {
                                codigo: data.codigo_tipo_comision,
                                nombre: data.nombre,
