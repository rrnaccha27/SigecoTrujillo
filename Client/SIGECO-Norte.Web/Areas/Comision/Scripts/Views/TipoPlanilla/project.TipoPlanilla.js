...
(function (app) {
    //===========================================================================================
    var current = app.TipoPlanilla = {};
    //===========================================================================================

    jQuery.extend(app.TipoPlanilla,
        {
            ...
            Initialize_DataGrid: function() {
                ...
                $('#DataGrid').datagrid({
                    ...
                    columns:
                    [[
                        { field: 'codigo_tipo_planilla', title: 'Codigo', width: 30, align: 'left' },
                        { field: 'nombre', title: 'Nombre', width: 100, align: 'left' },
                    ]],
                    onClickRow: function (index, row) {
                        var rowColumn = row['codigo_tipo_planilla'];
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.Msg) {
                            ...
                            Registro =
                            {
                                codigo: data.codigo_tipo_planilla,
                                nombre: data.nombre,
