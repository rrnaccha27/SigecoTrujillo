...
function fnConfigurarGrilla() {
    $('#dg_principal').datagrid({
        ...
        [[
            ...
            { field: 'numero_checklist', title: 'Nro. CheckList', width: 100, align: 'center' },
            { field: 'nombre_regla', title: 'Regla', width: 140, align: 'left' },
            ...
            { field: 'usuario_cierre', title: 'Usuarioz<br>Cierre', width: 100, align: 'left' },
            { field: 'fecha_anulacion', title: 'Fecha<br>Anulación', width: 120, align: 'center' },
            { field: 'usuario_anulacion', title: 'Usuarioz<br>Anulación', width: 100, align: 'left' },
