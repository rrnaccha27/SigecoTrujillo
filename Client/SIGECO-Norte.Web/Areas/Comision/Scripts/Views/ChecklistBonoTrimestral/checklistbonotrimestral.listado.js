...
function fnConfigurarListado() {
    ...
    $('#dgPlanilla').datagrid({
		...
		[[
            ...
            { field: 'nombre_regla', title: 'Regla', width: 200, align: 'left' },
            { field: 'anio_periodo', title: 'Periodo', width: 75, align: 'center' },
            { field: 'periodo', title: 'Meses<br>Periodo', width: 100, align: 'center' },
            { field: 'nombre_estado_planilla', title: 'Estado', width: 100, align: 'center'},
            { field: 'fecha_apertura', title: 'Fecha<br>Apertura', width: 150, align: 'center' },
            { field: 'fecha_cierre', title: 'Fecha<br>Cierre', width: 150, align: 'center' }
		]],
