...
(function (app) {
    //===========================================================================================
    var current = app.TipoVenta = {};
    //===========================================================================================

    jQuery.extend(app.TipoVenta,
        {
            ...
            Initialize: function (actionUrls) {
                ...
                $('#btnVisualizar').click(function () {
                    ...
                    if (!Registro.codigo) {
                        ...
                        $('#dlgVisualizar #abreviatura').textbox('setText', Registro.abreviatura);
            ...
            Modificar: function () {
                ...
                if (message.length > 0) {
                    ...
                    $.messager.confirm('Confirm', 'Seguro que desea modificar?', function (result) {
                        if (result) {
                            var mapData = { codigo: codigo, nombre: nombre, abreviatura: abreviatura };
            ...
            Registrar: function () {
                ...
                if (message.length > 0) {
                    ...
                    $.messager.confirm('Confirm', 'Seguro que desea registrar?', function (result) {
                        if (result) {
                            var mapData = { nombre: nombre, abreviatura: abreviatura };
