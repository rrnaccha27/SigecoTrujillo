...
(function (app) {
    //===========================================================================================
    var current = app.TipoDocumento = {};
    //===========================================================================================

    jQuery.extend(app.TipoDocumento,
        {
            ...
            Initialize_DataGrid: function() {
                ...
                $('#DataGrid').datagrid({
                    ...
                    columns:
                    [[
                        { field: 'codigo_tipo_documento', title: 'Codigo', width: 30, align: 'left' },
                        { field: 'nombre', title: 'Nombre', width: 100, align: 'left' },
                    ]],
                    onClickRow: function (index, row) {
                        var rowColumn = row['codigo_tipo_documento'];
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.Msg) {
                            ...
                            Registro =
                            {
                                codigo: data.codigo_tipo_documento,
                                nombre: data.nombre,
