...
(function (app) {
    //===========================================================================================
    var current = app.TipoPago = {};
    //===========================================================================================

    jQuery.extend(app.TipoPago,
        {
            ...
            Initialize_DataGrid: function() {
                ...
                $('#DataGrid').datagrid({
                    ...
                    columns:
                    [[
                        { field: 'codigo_tipo_pago', title: 'Codigo', width: 30, align: 'left' },
                        { field: 'nombre', title: 'Nombre', width: 100, align: 'left' },
                    ]],
                    onClickRow: function (index, row) {
                        var rowColumn = row['codigo_tipo_pago'];
