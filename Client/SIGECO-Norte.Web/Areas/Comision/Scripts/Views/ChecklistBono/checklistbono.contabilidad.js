...
function fnConfigurarGrillaEmpresas() {
    $('#dgv_resumen_planilla_txt').datagrid({
        ...
        [[
            ...
            { field: 'numero_planilla', title: 'Nro Planilla', width: 90, align: 'center' },
            { field: 'comisiones', title: 'Comisiones', width: 80, align: 'right' },
        ]],
...
function fnGenerarTxt() {
    ...
    var url = ActionContabilidadUrl.GenerarTxtContabilidad + "?codigo_checklist=" + ActionContabilidadUrl.codigo_checklist + "&codigo_empresa=" + row.codigo_empresa + "&codigo_planilla=" + row.codigo_planilla;
