...
{
    public partial class frm_liquidacion_bono_supervisor_general : System.Web.UI.Page
    {
        ...
        private void frmVerReporte(string p_codigo_planilla, string p_codigo_personal)
        {
            try
            {
               ...
               // Parameter [] param=new Parameter
                ...
                dt_General = PlanillaSelBL.Instance.ReporteLiquidacionBonoSupervisor(v_codigo_planilla,0);
                ...
                rpt_liquidacion_bono_supervisor.ZoomPercent = 120;
                rpt_liquidacion_bono_supervisor.ProcessingMode = ProcessingMode.Local;
                rpt_liquidacion_bono_supervisor.LocalReport.ReportPath = Server.MapPath("~/Areas/Comision/Reporte/PlanillaBono/rdl/rpt_liquidacion_bono_supervisor_general.rdlc");

                ReportDataSource dsDet = new ReportDataSource("dsLiquidacionBonoSupervisorGeneral", dt_detalle);
                ...
                rpt_liquidacion_bono_supervisor.LocalReport.SetParameters(new ReportParameter[] { p_porcentaje_detraccion });
