...
{
    public partial class frm_reporte_resumen_liquidacion : System.Web.UI.Page
    {
        ...
        private void frmVerReporte(string p_codigo_planilla)
        {
            try
            {
                ...
                {
                    v_titulo = "CORRESPONDIENTE DEL " + getNombreDia(_v_planilla.fecha_inicio) + " " + getDia(_v_planilla.fecha_inicio) + " de " + getNombreMes(_v_planilla.fecha_inicio) + " del " + getAnho(_v_planilla.fecha_inicio) +
                ...
                rpt_liquidacion.LocalReport.ReportPath = Server.MapPath("~/Areas/Comision/Reporte/Planilla/rdl/rpt_liquidacion_resumen" + _v_planilla.tipo_reporte + ".rdlc");
