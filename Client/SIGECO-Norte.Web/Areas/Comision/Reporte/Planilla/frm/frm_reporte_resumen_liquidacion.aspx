...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_reporte_resumen_liquidacion.aspx.cs" Inherits="SIGEES.Web.Areas.Comision.Reporte.Planilla.frm.frm_reporte_resumen_liquidacion" %>
...
<body>
    ...
    <div class=".ReportViewer" >
        ...
        <rsweb:ReportViewer ID="rpt_liquidacion" runat="server" Font-Names="Verdana" Font-Size="9pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="12pt"  Height="99%" Width="99%" ExportContentDisposition="AlwaysAttachment" SizeToReportContent="true" BackColor="White" ShowRefreshButton="False">
            <localreport reportembeddedresource="SIGEES.Web.Areas.Comision.Reporte.Planilla.rdl.rpt_liquidacion_resumen.rdlc">
                <DataSources>
