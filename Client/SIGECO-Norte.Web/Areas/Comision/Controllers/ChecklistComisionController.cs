...
namespace SIGEES.Web.Areas.Comision.Controllers
{
    ...
    public class ChecklistComisionController : Controller
    {
        ...
        public ChecklistComisionController()
        {
        ...
        public ActionResult _Buscar()
        {
            ...
            try
            {
                var lst = ChecklistComisionSelBL.Instance.Listar();
                v_total = lst.Count();
                query = from order in lst.AsEnumerable()
                        select new
                        {
                            ...
                            nombre_regla_tipo_checklist = order.nombre_regla_tipo_checklist,
                            codigo_regla_tipo_checklist = order.codigo_regla_tipo_checklist,
        ...
        {
            BeanItemTipoAcceso bean = new BeanItemTipoAcceso();
            ChecklistComisionViewModel vm = new ChecklistComisionViewModel();
            ...
            try
            {
                ...
                var checklist = ChecklistComisionSelBL.Instance.Detalle(codigo_checklist);
        ...
        public ActionResult GetPlanillaJson()
        {
            ...
            try
            {
                ...
                lst = PlanillaSelBL.Instance.ListarParaChecklistComision();
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GetDetalleJson(int codigo_checklist, int validado)
        {
            ...
            try
            {
                ...
                lst = ChecklistComisionSelBL.Instance.ListarDetalle(codigo_checklist, (validado==1?true:false));
            }
            catch (Exception ex)
            {
        ...
        #region Operaciones Checklist

        [HttpPost]
        [RequiresAuthentication]
        public ActionResult Aperturar(checklist_comision_estado_dto planilla)
        {
            int vResultado = 1;
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistComisionBL.Instance.Aperturar(planilla);
        ...
        [HttpPost]
        [RequiresAuthentication]
        public ActionResult Anular(checklist_comision_estado_dto checklist)
        {
            int vResultado = 1;
            string vMensaje = string.Empty;
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistComisionBL.Instance.Anular(checklist);
        ...
        [HttpPost]
        [RequiresAuthentication]
        public ActionResult Cerrar(checklist_comision_estado_dto checklist)
        {
            int vResultado = 1;
            string vMensaje = string.Empty;
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistComisionBL.Instance.Cerrar(checklist);
        ...
        [HttpPost]
        [RequiresAuthentication]
        public ActionResult Validar(List<checklist_comision_detalle_listado_dto> checklist_detalle)
        {
            int vResultado = 1;
            string vMensaje = string.Empty;
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistComisionBL.Instance.Validar(checklist_detalle, usuario);
        ...
        public FileResult GenerarTxtRRHH(int id)
        {
            ...
            try
            {
                ...
                List<cabecera_txt_dto> lst = PlanillaSelBL.Instance.GetReportePlanillaParaTxt(id);
        ...
        public FileResult GenerarTxtContabilidad(int codigo_checklist, int codigo_empresa, int codigo_planilla)
        {
            ...
            try
            {
                ...
                List<string> selectedfiles = new List<string>();
                List<txt_contabilidad_planilla_dto> lst = PlanillaSelBL.Instance.GetPlanillaTxt_Contabilidad(codigo_checklist, codigo_empresa, false, codigo_planilla);
        ...
        public ActionResult GetResumenPlanillaTxtJson(int codigo_planilla)
        {
            ...
            try
            {
                lst = PlanillaSelBL.Instance.GetResumenPlanillaTxt_Contabilidad(codigo_planilla);
            }
            catch (Exception ex)
            {
                string mensaje = ex.Message;
        ...
        private void EnvioTxtporCorreo(object parameters)
        {
            ...
            checklist_comision_listado_dto checklist = ChecklistComisionSelBL.Instance.Detalle(p_codigo_checklist);

            string[] datosCorreo = new string[(int)TemplateTxtParametros.total_enum];
            datosCorreo[(int)TemplateTxtParametros.tipo_checklist] = "Comision";
            ...
            datosCorreo[(int)TemplateTxtParametros.fecha] = DateTime.Now.ToShortDateString() + " " + String.Format("{0:T}", DateTime.Now);
            ...
            try
            {
                ...
                email.Subject = "Envío de TXT de CheckList Comision " + datosCorreo[(int)TemplateTxtParametros.numero_checklist];
