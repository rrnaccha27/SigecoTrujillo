...
namespace SIGEES.Web.Areas.Comision.Controllers
{
    ...
    {
        //
        private readonly TipoComisionService _service;
        ...
        {
            _service = new TipoComisionService();
        ...
        public ActionResult Registrar(string nombre)
        {
            ...
            tipo_comision tipo = new tipo_comision();
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    ...
                    listaBeanEntidad.Add(new BeanEntidad(codigo, "tipo_comision", listaBeanAtributo));
                }
                else
                {
