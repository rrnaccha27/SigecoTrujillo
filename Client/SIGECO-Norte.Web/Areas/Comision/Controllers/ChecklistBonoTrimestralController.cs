...
namespace SIGEES.Web.Areas.Comision.Controllers
{
    ...
    public class ChecklistBonoTrimestralController : Controller
    {
        ...
        public ChecklistBonoTrimestralController()
        {
        ...
        public ActionResult _Buscar()
        {
            ...
            try
            {
                var lst = ChecklistBonoSelBL.Instance.ListarTrimestral();
                v_total = lst.Count();
                query = from order in lst.AsEnumerable()
                        select new
                        {
                            ...
                            estilo = order.estilo,
                            nombre_regla = order.nombre_regla
                        };
            }
            catch (Exception ex)
            {
        ...
        public PartialViewResult _Planilla(int codigo_checklist)
        {
            ...
            try
            {
                ...
                var checklist = ChecklistBonoSelBL.Instance.DetalleTrimestral(codigo_checklist);
        ...
        public ActionResult GetPlanillaJson()
        {
            ...
            try
            {
                ...
                lst = PlanillaSelBL.Instance.ListarParaChecklistBonoTrimestral();
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GetDetalleJson(int codigo_checklist, int validado)
        {
            ...
            try
            {
                ...
                lst = ChecklistBonoSelBL.Instance.ListarDetalleTrimestral(codigo_checklist, (validado==1?true:false));
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Aperturar(checklist_bono_estado_dto planilla)
        {
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistBonoBL.Instance.AperturarTrimestral(planilla);
        ...
        public ActionResult Anular(checklist_bono_estado_dto checklist)
        {
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistBonoBL.Instance.AnularTrimestral(checklist);
        ...
        public ActionResult Cerrar(checklist_bono_estado_dto checklist)
        {
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistBonoBL.Instance.CerrarTrimestral(checklist);
        ...
        [HttpPost]
        [RequiresAuthentication]
        public ActionResult EnviarTXT(checklist_bono_estado_dto checklist)
        {
            int vResultado = 1;
            string vMensaje = string.Empty;
        ...
        public ActionResult Validar(List<checklist_bono_detalle_listado_dto> checklist_detalle)
        {
            ...
            try
            {
                ...
                MensajeDTO mensaje = ChecklistBonoBL.Instance.ValidarTrimestral(checklist_detalle, usuario);
        ...
        public FileResult GenerarTxtRRHH(int id)
        {
            ...
            try
            {
                ...
                List<cabecera_txt_dto> lst = ChecklistBonoSelBL.Instance.TXTParaRRHH(id);
                ...
                string name_zip = DateTime.Now.ToString("dd-MM-yyyy", System.Globalization.CultureInfo.InvariantCulture);
        ...
        public ActionResult GetResumenPlanillaTxtJson(int codigo_planilla)
        {
            ...
            try
            {
                lst = ChecklistBonoSelBL.Instance.TXTResumenParaContabilidad(codigo_planilla);
            }
            catch (Exception ex)
            {
                string mensaje = ex.Message;
        ...
        public FileResult GenerarTxtContabilidad(int codigo_planilla, int codigo_empresa)
        {
            ...
            try
            {
                ...
                List<string> selectedfiles = new List<string>();
                List<txt_contabilidad_planilla_dto> lst = ChecklistBonoSelBL.Instance.TXTParaContabilidad(codigo_planilla, codigo_empresa);
                checklist_bono_listado_dto checklist = ChecklistBonoSelBL.Instance.DetalleTrimestral(codigo_planilla);
                string numero_planilla = checklist.numero_checklist;
        ...
        private void EnvioTxtporCorreo(object parameters)
        {
            ...
            checklist_bono_listado_dto checklist = ChecklistBonoSelBL.Instance.DetalleTrimestral(p_codigo_checklist);

            string[] datosCorreo = new string[(int)TemplateTxtParametros.total_enum];
            datosCorreo[(int)TemplateTxtParametros.tipo_checklist] = "Bono Trimestral";
            ...
            try
            {
                ...
                email.Subject = "Envío de TXT de CheckList Bono Trimestral " + datosCorreo[(int)TemplateTxtParametros.numero_checklist];

                email.Body = contenidoCorreo;
                email.IsBodyHtml = true;
                email.Priority = MailPriority.High;
                smtp.Send(email);
                log.Info("Se envío correo a : " + cuentas.email + " - " + datosCorreo[(int)TemplateTxtParametros.numero_checklist]);
                email.Attachments.Clear();
            }
            catch (Exception ex)
            {
                string mensaje = ex.Message;
                log.Error("Ocurrio error al enviar correo a : " + cuentas.email + "(" + mensaje + ")");
            }
            finally
            {
                email = null;
            ...
            try
            {
                ...
                List<txt_contabilidad_resumen_planilla_dto> lst = ChecklistBonoSelBL.Instance.TXTResumenParaContabilidad(p_codigo_checklist);
                string[] archivos = new string[lst.Count()];

                foreach (txt_contabilidad_resumen_planilla_dto elemento in lst)
                {
                    savePath = string.Empty;
                    GenerarTxtContabilidad(p_codigo_checklist, elemento.codigo_empresa);
