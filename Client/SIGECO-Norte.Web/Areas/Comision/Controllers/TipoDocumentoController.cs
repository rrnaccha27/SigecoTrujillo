    ...
    public class TipoDocumentoController : Controller
    {
        ...
        public ActionResult Registrar(string nombre)
        {
            ...
            try
            {
                ...
                tipo.nombre_tipo_documento = nombre;
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    listaBeanAtributo.Add(new BeanAtributo("nombre", tipo.nombre_tipo_documento));
                    ...
                    listaBeanEntidad.Add(new BeanEntidad(codigo, "tipo_documento", listaBeanAtributo));
                }
                else
                {
        ...
        public ActionResult Modificar(string codigo, string nombre)
        {
            ...
            try
            {
                ...
                registro.nombre_tipo_documento = nombre;
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    listaBeanAtributo.Add(new BeanAtributo("nombre", registro.nombre_tipo_documento));
