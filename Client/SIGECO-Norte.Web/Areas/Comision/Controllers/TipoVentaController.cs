...
namespace SIGEES.Web.Areas.Comision.Controllers
{
    ...
    {
        //
        private readonly TipoVentaService _service;
        ...
        public TipoVentaController()
        {
            _service = new TipoVentaService();
        ...
        [HttpPost]
        public ActionResult Registrar(string nombre, string abreviatura)
        {
            ...
            try
            {
                ...
                {
                    jo.Add("Msg", "ABREVIATURA, NUMERO MAXIMO DE CARACTERES 10");
                    return Content(JsonConvert.SerializeObject(jo), "application/json");
                }
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    ...
                    listaBeanAtributo.Add(new BeanAtributo("abreviatura", tipo.abreviatura));
                    ...
                    listaBeanEntidad.Add(new BeanEntidad(codigo, "tipo_venta", listaBeanAtributo));
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult Modificar(string codigo, string nombre, string abreviatura)
        {
            bool estadoEvento = false;
            tipo_venta registro = null;
            ...
            try
            {
                ...
                registro.abreviatura = abreviatura;
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    ...
                    listaBeanAtributo.Add(new BeanAtributo("abreviatura", registro.abreviatura));
