...
namespace SIGEES.Web.Areas.Comision.Controllers
{
    ...
    {
        //
        private readonly TipoPlanillaService _service;
        ...
        public TipoPlanillaController()
        {
            _service = new TipoPlanillaService();
        ...
        public ActionResult Registrar(string nombre)
        {
            ...
            tipo_planilla tipo = new tipo_planilla();
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    ...
                    listaBeanEntidad.Add(new BeanEntidad(codigo, "tipo_planilla", listaBeanAtributo));
                }
                else
                {
