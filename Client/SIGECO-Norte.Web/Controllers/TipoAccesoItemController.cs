...
namespace SIGEES.Web.Controllers
{
    ...
    public class TipoAccesoItemController : Controller
    {
        //
        private readonly ITipoAccesoItemService _service;
        ...
        public TipoAccesoItemController()
        {
            _service = new TipoAccesoItemService();
            _EventoUsuarioService = new EventoUsuarioService();
        }
        public ActionResult Index()
        {
            BeanItemTipoAcceso bean = new BeanItemTipoAcceso();
            bean = _service.GetBeanItemTipoAcceso(beanSesionUsuario.codigoPerfil);
            return View(bean);
        }
        ...
        public ActionResult Registrar(string nombre)
        {
            ...
            tipo_acceso_item tipo = new tipo_acceso_item();
            ...
            try
            {
                ...
                tipo.nombre_tipo_acceso_item = nombre;
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    listaBeanAtributo.Add(new BeanAtributo("nombre_tipo_acceso_item", tipo.nombre_tipo_acceso_item));
                    ...
                    listaBeanEntidad.Add(new BeanEntidad(codigo, "tipo_acceso_item", listaBeanAtributo));
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult Modificar(string codigo, string nombre)
        {
            bool estadoEvento = false;
            tipo_acceso_item registro = null;
            ...
            try
            {
                ...
                registro.nombre_tipo_acceso_item = nombre;
            ...
            try
            {
                ...
                if (estadoEvento)
                {
                    listaBeanAtributo.Add(new BeanAtributo("nombre_tipo_acceso_item", registro.nombre_tipo_acceso_item));
