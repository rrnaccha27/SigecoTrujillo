...
namespace SIGEES.Web.Models
{
    ...
    public partial class detalle_conversion_espacio
    {
        public int codigo_detalle_conversion_espacio { get; set; }
        ...
        public virtual conversion_espacio conversion_espacio { get; set; }
